...
OWNER_ID = environ.get('OWNER_ID', '1496229374')
...
CHAT_GROUP = int(environ.get("CHAT_GROUP", "-1002170681398"))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1496229374').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002361359957').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1496229374').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jonidarkmk:kS4Bzo6BfIpn88jt@cluster0.f9zvk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002404815695')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002398914394'))
...
BOT_USERNAME = environ.get("BOT_USERNAME", "pandadm02_bot")
BOT_NAME = environ.get("BOT_NAME", "Panda 🐼")
